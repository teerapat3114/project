...
const Mypost = () => {
    ...
    const postList = post.map((e,i) => (
        <div className="post" key={e.id}>
            ...
            setPostToDelete([e.id, e.picture])} }>
                &times;</span>
            ...
            <div className="post-detail">
                ...
                <button type="button" className="btn-edit" onClick={()=>setEditPost(e)}>แก้ไข</button>
            </div>
        </div>
    ))
            ...
            <form onSubmit={(event)=>{editPost(event)}}>
                <div className="popup-content">
                        ...
                        formatChangeEdit(document.getElementById("format-edit").value)}}>
                            ...
                            <option value="การแลกเปลี่ยนแบบส่งของ">การแลกเปลี่ยนแบบส่งของ</option>
                        </select>
                        <br></br>
